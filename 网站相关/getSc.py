...
import pandas as pd
session = HTMLSession()
url = ['https://nba.hupu.com/games/boxscore/157130',
  'https://nba.hupu.com/games/boxscore/157131',
  'https://nba.hupu.com/games/boxscore/157132',
  'https://nba.hupu.com/games/boxscore/157133',
  'https://nba.hupu.com/games/boxscore/157134',
  'https://nba.hupu.com/games/boxscore/157135',
  'https://nba.hupu.com/games/boxscore/157136',
  'https://nba.hupu.com/games/boxscore/157137',
  'https://nba.hupu.com/games/boxscore/157138',
  'https://nba.hupu.com/games/boxscore/157139']
...
def get_url(url1):
    ...
    # print(tStr)
    dataArr = [[tStr,arr[0][0],arr[1][0],str1,arr[2][0],arr[3][0],hp,hpp,hr,hrp,ha,hap,hs,hsp,hb,hbp,ap,app,ar,arp,aa,aap,ass,asp,ab,abp,_link[0],url1]]
    # print(dataArr)

    df= pd.DataFrame(dataArr)
    # df.columns = ['时间','主队','客队','比分','主队得分','客队得分','主队最高得分','主队最高得分球员','主队最高篮板','主队最高篮板球员','主队最高助攻','主队最高助攻球员','主队最高抢断',
    # '主队最高抢断球员','主队最高盖帽','主队最高盖帽球员','客队最高得分','客队最高得分球员','客队最高篮板','客队最高篮板球员','客队最高助攻','客队最高助攻球员','客队最高抢断'
    # ,'客队最高抢断球员','客队最高盖帽','客队最高盖帽球员','新闻链接','数据链接']
    df.to_csv('sc.csv',encoding='gbk',index=False,mode='a',header=False)
